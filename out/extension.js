...
const domainContextGenerator_1 = require("./services/domainContextGenerator");
...
function activate(context) {
    ...
    const baseExtPath = context.extensionPath;
    const domainContextGeneratorHandler = vscode.commands.registerCommand(`${constants_1.EXT_PREFFIX}${constants_1.DOMAIN_CONTEXT}`, () => { (0, domainContextGenerator_1.domainContextGenerator)(baseExtPath); });
